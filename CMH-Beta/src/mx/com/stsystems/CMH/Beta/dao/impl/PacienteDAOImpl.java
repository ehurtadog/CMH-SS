...
public class PacienteDAOImpl implements PacienteDAO {
	...
	public long registraPaciente(MensajeRegistroPaciente registroPaciente) throws SumarSaludException {
		...
		try {
			...
			String mensajeDeError = "Ocurri√≥ un error al registrar al paciente: " + dae.getMessage();
//			System.err.println(mensajeDeError);
	...
	public boolean buscaPacientePorCorreoElectronico(String correoElectronico) {
		...
		try {
			...
			System.err.println("Ocurri√≥ un error al consultar el paciente por correo electr√≥nico: " + dae);
		}
...
<<<<<<< HEAD
			String mensajeDeError = "OcurriÛ un error al consultar un paciente por el id de filiaciÛn: " + dae;
			System.err.println(mensajeDeError);
			throw new SumarSaludException(mensajeDeError);
		}
	...
	public Paciente consultaPacientePorCorreoElectronico(String correoElectronico) throws SumarSaludException {
		...
		try {
			...
			String mensajeDeError = "OcurriÛ un error al consultar un paciente por el correo electrÛnico: " + dae;
=======
			String mensajeDeError = "Ocurri√≥ un error al consulta un paciente por el id de filiaci√≥n: " + dae;
